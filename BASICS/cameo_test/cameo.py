import cv2
from BASICS.cameo_test.temp import WindowManager, CaptureManager
...
class Cameo(object):
    def __init__(self):
        ...
        # 告诉程序数据来自摄像头， 还有镜面效果
        self._captureManager = CaptureManager(capture=cv2.VideoCapture(0), previewWindowManager=self._windowManager, shouldMirrorPreview=True)
